...
#%%
def getportfolio(long,short,year, num,price,short_ratio):
...
def back_track(year):
    ...
    p1,p4,p7,p8,p10 = getportfolio(stock_long_pool, stock_short_pool, year, 50, 10,0.5)
...
cumsum = 1
for i in range(58):
    cumsum = cumsum*(1+result.iloc[i,-1]/100)